...
export const stages = {
  ...
  '2.2': {
    id: '2.2',
    title: '吃個海鮮大餐',
    content: '這是你們來到尼斯的第一餐，雖然價格很貴，但義大利麵份量超級大，海鮮也超級新鮮，你們吃的很開心！跟店員結帳的時候也因為要開始練習妳的法文，所以有些緊張。但最後還是完美地做到了！(妳真棒！)',
    media: {
      type: 'image',
      src: '2.2.JPG'
    },
  ...
  '2.3': {
    id: '2.3',
    title: '去海邊走走',
    content: '你們終於來到了海邊，這裡的海水超級藍，沙灘也很乾淨，你們在海邊坐著，看看日落！真的看到這一幕的時候，妳感覺到這就是妳出國的原因！(看到妳開心的時候我也很開心)',
    media: {
      type: 'image',
      src: '2.3.JPG'
    },
  ...
  '3.1': {
    id: '3.1',
    title: '芒通',
    content: '你們決定去芒通，這裡的聖米歇爾階梯超夢幻!!後面還看得到海超級美!!希望妳在芒通玩得開心!!',
    media: {
      type: 'image',
      src: '3.1.JPG'
    },
  ...
  '3.2': {
    id: '3.2',
    title: '城堡山公園',
    content: '你們決定去城堡山公園，爬山爬了一陣子，但是看到上面的景色，老城區配上海景，就覺得太直得了！(只要旁邊沒有一堆小朋友就好了)',
    media: {
      type: 'image',
      src: '3.2.JPG'
    },
