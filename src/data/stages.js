...
export const stages = {
  ...
  7.1: {
    id: "7.1",
    title: "H 哥家",
    content: "到了 H 哥家，吃的東西突然變好吃了，他決定要做 BBQ，你們很感動，因為在 K 哥家都吃不到好吃的東西",
    media: {
      type: "video",
      src: "7.1.MP4",
    },
  ...
  7.2: {
    ...
    content: "你們看到自己的房間很感動，因為旁邊就是自己的廁所，而且床也很舒服，沒有蚊帳掛在旁邊。房間外看出去就是游泳池也很讓人興奮。",
    media: {
      type: "image",
      src: "7.2.JPG",
    },
  ...
  8: {
    id: "8",
    title: "開始工作",
    content: "工作跟 K 哥家相比輕鬆很多，H 哥也會定期來跟你們說:'That's lovely! You did a great job!'下午有一些時間，你想要怎麼安排?",
    media: {
      type: "image",
      src: "8.JPG",
    },
  ...
  8.1: {
    id: "8.1",
    title: "游泳",
    content: "妳想要開始學游泳，H哥跟冠傑有教你一些技巧，妳確實有進步很多，相信妳未來一定可以成為游泳高手！",
    media: {
      type: "video",
      src: "8.1.MP4",
    },
  ...
  8.2: {
    id: "8.2",
    title: "H哥導覽",
    content: "H哥帶你們出去走走，他的步調很快，看一看就走掉，唯一停下來的地方是冰淇淋店，妳們在這裡吃了冰淇淋，蠻好吃的！",
    media: {
      type: "image",
      src: "8.2.JPG",
    },
  ...
  8.3:{
    id: "8.3",
    title: "出去騎腳踏車",
    content: "其時妳也不想騎腳踏車，但你們吹風機壞掉了，想說可以簡單騎一下買個吹風機，沒想到屁股快開花了。",
    media: {
      type: "image",
      src: "8.3.JPG",
    },
  ...
  9: {
    id: "9",
    title: "Raclette 初體驗",
    content: "H 哥家有 Raclette 的機器，這是你們第一次體驗到的瑞士美食，有鮭魚跟蝦子，超級好吃！",
    media: {
      type: "video",
      src: "9.MP4",
    },
  ...
  10: {
    id: "10",
    title: "道別",
    content: "三個禮拜過得很快，你們準備要離開了。但因為你們覺得 H 哥家很不錯，所以決定秋天時再來一次。我們也來跟Ginger道別，跟他說我們下次見。",
    media: {
      type: "video",
      src: "10.MOV",
    },
